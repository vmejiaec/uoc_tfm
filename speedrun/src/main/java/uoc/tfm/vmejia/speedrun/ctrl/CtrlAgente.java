    ...
    public static void Configurar(Agente agente, String casoid){
        switch (casoid){
            case "sc_caso1" :
                ...
                agente.material = MaterialModelo.tipo.CACAO;
                agente.cantidad = 5;
                agente.producto = MaterialModelo.tipo.PAN;
                break;
            case "sc_caso2":
                //Ir al Almacen 1 y traer Material 1-3 y poner en el cofre 1
                agente.destino = Agente.destinotipo.ALALMACEN1;
                agente.material = MaterialModelo.tipo.LECHE;
                agente.cantidad = 5;
                agente.producto = MaterialModelo.tipo.PAN;
                break;
            case "sc_caso3":
            ...
            case "sc_caso5":
                ...
                agente.destino = Agente.destinotipo.ALALMACEN1;
                agente.material = MaterialModelo.tipo.HUEVO;
                agente.cantidad = 5;
                agente.producto = MaterialModelo.tipo.GALLETA;
                break;
            case "sc_caso6":
                //Ir al Almacen 2 y traer Material 2-4 y poner en el cofre 2
                agente.destino = Agente.destinotipo.ALALMACEN2;
                agente.material = MaterialModelo.tipo.TRIGO;
                agente.cantidad = 5;
                agente.producto = MaterialModelo.tipo.GALLETA;
                break;
            case "sc_caso7":
            ...
            case "sc_caso9":
                ...
                agente.material = MaterialModelo.tipo.HUEVO;
                agente.cantidad = 5;
                agente.producto = MaterialModelo.tipo.PASTEL;
                break;
            case "sc_caso10":
